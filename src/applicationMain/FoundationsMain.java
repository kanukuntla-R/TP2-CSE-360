...
public class FoundationsMain extends Application {
	...
	**********************************************************************************************/
	...
	public static boolean isFirstAdminSetup = false;	// Flag to track if this is the first admin setup
	...
	public void start(Stage theStage) {
		...
		if (database.isDatabaseEmpty()) {
			isFirstAdminSetup = true;	// Set flag to indicate this is first admin setup
