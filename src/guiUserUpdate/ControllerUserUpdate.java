...
public class ControllerUserUpdate {
	...
	**********************************************************************************************/
	...
	protected static void goToUserHomePage(Stage theStage, User theUser) {
		...
		// Check if this is the first admin setup. if so, redirect to login page instead of home page
				if (applicationMain.FoundationsMain.isFirstAdminSetup) {
				    // This is the first admin setup, redirect to login page
				    applicationMain.FoundationsMain.isFirstAdminSetup = false;  // Reset flag
