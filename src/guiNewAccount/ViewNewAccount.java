...
public class ViewNewAccount {
	...
	*/
	...
	protected static Alert usernameTakenAlert = new Alert(Alert.AlertType.INFORMATION);
	protected static Alert usernameInvalidAlert = new Alert(Alert.AlertType.INFORMATION);
	protected static Alert passwordInvalidAlert = new Alert(Alert.AlertType.INFORMATION);
	...
	*/
	...
	private ViewNewAccount() {
		...
		// If the invitation code is wrong, this alert dialog will tell the user
				alertInvitationCodeIsInvalid.setTitle("Invalid or Expired Invitation Code");
				alertInvitationCodeIsInvalid.setHeaderText("The invitation code is not valid or has expired.");
				alertInvitationCodeIsInvalid.setContentText("Correct the code or Request a new code and try again.");
