...
public class ControllerAdminHome {
	...
	*/
	...
	protected static void performInvitation () {
		...
		theDatabase.purgeExpiredInvitationsForEmail(emailAddress);   //clear stale invites
		...
		// Inform the user that the invitation has been sent and display the invitation code
				...
				String msg = "Code: " + invitationCode + " for role " + theSelectedRole +
				             ...
				             " (valid for " + database.Database.INVITATION_TTL_MINUTES + " minutes).";
	 ...
	 * 
	 * <p> Description: Shows information about current invitations and allows management. </p>
	 */
	 ...
	 * 
	 * <p> Description: Navigates to the Delete User page where admins can select and delete users. </p>
	 */
	 ...
	 * 
	 * <p> Description: Displays a table view of all users in the system. </p>
	 */
	protected static void listUsers() {
		ViewUserList.displayUserList();
	}
	...
	protected static boolean invalidEmailAddress(String emailAddress) {
		...
		String emailValidationError = inputValidator.checkForValidEmail(emailAddress);
		if (!emailValidationError.isEmpty()) {
			// Show the specific validation error message
			ViewAdminHome.alertEmailError.setContentText(emailValidationError);
			ViewAdminHome.alertEmailError.showAndWait();
			return true;
		}
		return false;
